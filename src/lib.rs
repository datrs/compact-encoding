...
//! enc_state.preencode(&number);
//! enc_state.preencode(&str);
//!
...
//! enc_state.encode(&number, &mut buffer);
//! enc_state.encode(&str, &mut buffer);
...
//! let number_dec: u32 = dec_state.decode(&buffer);
//! let str_dec: String = dec_state.decode(&buffer);
